...
func (ps *PreemptionSignal) Listen() <-chan struct{} { _ = "STUB: not implemented"; return nil }

// Preempt causes any past and future calls of Listen to return a closed channel.
func (ps *PreemptionSignal) Preempt() { _ = "STUB: not implemented"; return }
...
func (th *timeoutScheduler) scheduleTimeout(d time.Duration) { _ = "STUB: not implemented"; return }
