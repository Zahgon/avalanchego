...
type CodeHandler = Handler[*syncpb.GetCodeRequest, *syncpb.CodeResponse]

// CodeResponder is the inner contract for code-by-hash requests.
type CodeResponder = Responder[*syncpb.GetCodeRequest, *syncpb.CodeResponse]
...
func (r *codeResponder) Respond(_ context.Context, nodeID ids.NodeID, req *syncpb.GetCodeRequest) (*syncpb.CodeResponse, error) {
	startTime := time.Now()
	...
	return &syncpb.CodeResponse{Data: data}, nil
}
