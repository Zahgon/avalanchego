...
type (
	FakeBlockResponder = FakeResponder[*syncpb.GetBlockRequest, *syncpb.BlockResponse]
	FakeCodeResponder  = FakeResponder[*syncpb.GetCodeRequest, *syncpb.CodeResponse]
	FakeLeafResponder  = FakeResponder[*syncpb.GetLeafsRequest, *syncpb.LeafsResponse]
)
