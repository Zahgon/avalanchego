...
func newLimbo(datadir string) (*limbo, error) { _ = "STUB: not implemented"; return nil, nil }

// Index all limboed blobs on disk and delete anything unprocessable

// Close closes down the underlying persistent store.
func (l *limbo) Close() error { _ = "STUB: not implemented"; return nil }
...
func (l *limbo) parseBlob(id uint64, data []byte) error { _ = "STUB: not implemented"; return nil }
...
// cannot happen runtime, dev error
