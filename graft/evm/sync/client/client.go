...
func New(config *Config) *client { _ = "STUB: not implemented"; return nil }

func (c *client) AddClient(handlerID uint64) *p2p.Client { _ = "STUB: not implemented"; return nil }

func (c *client) StateSyncNodes() []ids.NodeID { _ = "STUB: not implemented"; return nil }
