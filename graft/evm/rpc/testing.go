...
func (*testConn) closed() <-chan interface{} { _ = "STUB: not implemented"; return nil }

func (*testConn) remoteAddr() string {
	_ = "STUB: not implemented"
...
func NewTestNotifier(w io.Writer, subID ID) *Notifier { _ = "STUB: not implemented"; return nil }
