...
func Dial(rawurl string) (Client, error) { _ = "STUB: not implemented"; return *new(Client), nil }
...
func NewClient(c *rpc.Client) Client { _ = "STUB: not implemented"; return *new(Client) }
